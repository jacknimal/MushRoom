...
class KnnModule(torch.nn.Module):
    """
    Gets knn of val features from all processes on a chunk of the train features

    Each rank gets a chunk of the train features as well as a chunk of the val features.
    In `compute_neighbors`, for each rank one after the other, its chunk of val features
